...
Java_br_com_raphaelmaracaipe_core_network_utils_ApiKeyExternal_getApiKeyDev(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_br_com_raphaelmaracaipe_core_network_utils_ApiKeyExternal_getApiKeyProd(JNIEnv *env, jobject thiz) {
